...
local toKeep = {
  ...
  --Virgem Two
  [15425] = {'Incomum','Raro','Épico','Lendario','Mitico'},
  [15426] = {'Incomum','Raro','Épico','Lendario','Mitico'},
  [15427] = {'Incomum','Raro','Épico','Lendario','Mitico'},
  [15428] = {'Incomum','Raro','Épico','Lendario','Mitico'},
  [15429] = {'Incomum','Raro','Épico','Lendario','Mitico'},
  [15430] = {'Incomum','Raro','Épico','Lendario','Mitico'},
  --[14861] = {'Incomum','Raro','Épico','Lendario','Mitico'},
...
onTalk(function(name, level, mode, text, channelId, pos)
    if name ~= player:getName() or not storage.ultimate then return end
